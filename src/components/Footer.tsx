...
export const Footer: React.FC<{ onNavigate: (route: string) => void }> = ({ onNavigate }) => {
  ...
  return (
    <footer className="bg-[#050811] border-t border-[#1a2336] pt-16 pb-12 relative overflow-hidden">
      {/* Background glow */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li>
                <button onClick={() => onNavigate('signup')} className="hover:text-amber-400 transition-colors">
                  Join / Sign Up
                </button>
              </li>
              <li>
              ...
              <li>
                <button onClick={() => onNavigate('checkout')} className="hover:text-amber-400 transition-colors">
                  Activation Gateway
                </button>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <div>
            © {new Date().getFullYear()} UltraPay Platform. All rights reserved. Transparent community wealth platform.
          </div>
